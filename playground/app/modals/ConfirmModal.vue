  ...
  >
    ...
    >
      <div class="border-b border-sky-100 bg-sky-50 px-6 py-5">
        <div class="text-xs font-semibold tracking-[0.24em] text-sky-700 uppercase">Confirm</div>
      ...
      <div class="space-y-5 px-6 py-6">
        ...
        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <div class="text-sm font-medium text-slate-900">Promise behavior</div>
          <p class="mt-2 text-sm leading-6 text-slate-600">
            This modal resolves to <code>true</code> or <code>false</code> depending on which button
